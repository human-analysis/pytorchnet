...
# ======================== Data Setings ============================================
parser.add_argument('--dataset-test', type=str, default=None, metavar='', help='name of training dataset')
parser.add_argument('--dataset-train', type=str, default=None, metavar='', help='name of training dataset')
...
parser.add_argument('--net-type', type=str, default=None, metavar='', help='type of network')
...
parser.add_argument('--learning-rate', type=float, default=None, metavar='', help='learning rate')
parser.add_argument('--learning-rate-decay', type=float, default=None, metavar='', help='learning rate decay')
parser.add_argument('--momentum', type=float, default=None, metavar='', help='momentum')
parser.add_argument('--weight-decay', type=float, default=None, metavar='', help='weight decay')
parser.add_argument('--adam-beta1', type=float, default=None, metavar='', help='Beta 1 parameter for Adam')
parser.add_argument('--adam-beta2', type=float, default=None, metavar='', help='Beta 2 parameter for Adam')
